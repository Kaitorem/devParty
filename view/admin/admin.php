...
if ($user->getRole()->getLibelle() === 'Etudiant') {
    ...
    header("Location: hhttp://localhost:8888/sitedev/DevParty/view/public/index.php");
...
<html lang="fr">
	...
	<!-- Fin Section Héro -->
		...
		<section class="adminusers">
			<div class="adminusers-content container">
				<h4>Gestion des utilisateurs :</h4>
				<hr>
				<div class="adduser">
					<form class="register-form" action="../../controller/admin/inscriptionAdmin.php" method="post">
						<input class="adduser-name" type="text" placeholder="nom" name="nom"/>
						<input class="adduser-name" type="text" placeholder="prénom" name="prenom"/>
						<input class="adduser-password" type="password" placeholder="password" name="mdp"/>
						<input class="adduser-email" type="text" placeholder="email" name="email"/>
                        <select name="role" id="role" class="adduser-name">
                            <option value="" selected disabled>Role</option>
                            <?php
                            $roles = \App\Repository\RoleRepository\findAll();
		...
		<!-- Fin formulaire Ajout Utilisateur -->
		...
		<section class="adminusers">
			<div class="adminusers-content container">
				...
				<hr>
				<div class="adduser">
					<form class="register-form" action="../../Controller/admin/addCategorie.php" method="post">
						<input class="adduser-name" type="text" placeholder="nom" id="libelleCategorie" name="libelle"/>
						<button>créer</button>
					</form>
				</div>
			</div>
